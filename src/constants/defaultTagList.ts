const defaultTagList = [
    ...
    {name: '水电费',svg:'水电费', type: 'expense'},
    {name: '交通费',svg:'交通费', type: 'expense'},
    {name: '电话费',svg:'电话费', type: 'expense'},
    {name: '房费',svg:'房费', type: 'expense'},
    {name: '工资',svg:'工资', type: 'income'},
    {name: '零花钱',svg:'零花钱', type: 'income'},
    {name: '奖金',svg:'奖金', type: 'income'},
